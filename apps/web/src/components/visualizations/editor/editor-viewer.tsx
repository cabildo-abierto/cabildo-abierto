...
import {DatasetFullView} from "./datasets/dataset-full-view";
...
} from "./visualization-editor";

import dynamic from "next/dynamic";
import {EditableDatasetFullView} from "./datasets/editable-dataset-full-view";
