...
export const BaseTextFieldWithSuggestions: React.FC<BaseTextFieldWithSuggestionsProps> = ({
   value,
   onChange,
   options,
   optionViews,
    ...
    return (
        <div className="relative">
            ...
            {showContent && (
                <div
                    className={"absolute z-20 mt-1 w-full max-h-[300px] overflow-y-auto bg-[var(--background-dark)] border border-[var(--accent-dark)] custom-scrollbar group-[.portal]:bg-[var(--background-dark2)]"}
