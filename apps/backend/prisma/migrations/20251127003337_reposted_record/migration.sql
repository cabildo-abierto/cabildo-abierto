...
-- AddForeignKey
ALTER TABLE "FollowingFeedIndex" ADD CONSTRAINT "FollowingFeedIndex_repostedContentId_fkey" FOREIGN KEY ("repostedContentId") REFERENCES "Record"("uri") ON DELETE SET NULL ON UPDATE CASCADE;
