    ...
    return <div
        ...
        <div className={"md:flex md:space-x-6 md:w-full md:justify-between md:items-center"}>
            <div className={"space-y-6"}>
                <h1 className={"max-w-[400px] md:pt-0 pt-16 leading-none tracking-tight w-full flex justify-center text-xl md:text-2xl"}>
                    Un nuevo espacio de discusión argentino.
                </h1>
