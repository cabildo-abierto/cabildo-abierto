"use server"
import {db} from "@/db";
import {TopicHistoryProps, TopicProps} from "@/lib/definitions";
import {revalidateTags} from "../admin";
import {setTopicCategories, setTopicSynonyms} from "./utils";
import {getCurrentContentVersion, getTopicLastEditFromVersions} from "@/components/topics/topic/utils";
