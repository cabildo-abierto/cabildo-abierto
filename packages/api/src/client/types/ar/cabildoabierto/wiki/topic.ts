...
const is$typed = _is$typed,
  validate = _validate
const id = 'ar.cabildoabierto.wiki.topic'
...
export interface TopicView {
  $type?: 'ar.cabildoabierto.wiki.topic#topicView'
  id: string
  uri: string
  cid: string
...
export interface TopicHistory {
  $type?: 'ar.cabildoabierto.wiki.topic#topicHistory'
  id: string
...
export interface VersionInHistory {
  $type?: 'ar.cabildoabierto.wiki.topic#versionInHistory'
  uri: string
  cid: string
  createdAt: string
  author: ArCabildoabiertoActorDefs.ProfileViewBasic
...
export interface TopicVersionViewerState {
  $type?: 'ar.cabildoabierto.wiki.topic#topicVersionViewerState'
  accept?: string
  reject?: string
}
...
export interface BooleanProp {
  $type?: 'ar.cabildoabierto.wiki.topic#booleanProp'
  value: boolean
}
...
export interface DateProp {
  $type?: 'ar.cabildoabierto.wiki.topic#dateProp'
  value: string
}
...
export interface CalendarDateProp {
  $type?: 'ar.cabildoabierto.wiki.topic#calendarDateProp'
  /** Fecha en formato ISO 8601, sin hora, con separador '-'. Ejemplo: 2023-01-30. */
  value: string
}

const hashCalendarDateProp = 'calendarDateProp'

export function isCalendarDateProp<V>(v: V) {
  return is$typed(v, id, hashCalendarDateProp)
}

export function validateCalendarDateProp<V>(v: V) {
  return validate<CalendarDateProp & V>(v, id, hashCalendarDateProp)
}

export interface NumberProp {
  $type?: 'ar.cabildoabierto.wiki.topic#numberProp'
  value: number
}
...
export interface TopicVersionContribution {
  $type?: 'ar.cabildoabierto.wiki.topic#topicVersionContribution'
  monetized: string
  all: string
}
...
export interface TopicPopularity {
  $type?: 'ar.cabildoabierto.wiki.topic#topicPopularity'
  lastDay: number[]
  lastWeek: number[]
  lastMonth: number[]
}
