...
const Page = () => {
    ...
    return (
        <div className="flex justify-between w-screen bg-gray-200">
            <div className="hidden w-64 sm:flex items-end h-screen px-2">
            ...
            <div className="hidden w-64 sm:flex flex-col items-center justify-end h-screen px-4">
