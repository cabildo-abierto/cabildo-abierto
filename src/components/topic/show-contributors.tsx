...
export const ShowContributors = ({topicId}:
    ...
    if(lastVersion.content.topicVersion.accCharsAdded == 0){
    ...
    try {
        let contributionsBoth: BothContributionsProps = JSON.parse(lastVersion.content.topicVersion.contribution)
