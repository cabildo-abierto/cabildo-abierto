        ...
        <div className="flex">
            <div className="h-screen w-64 flex flex-col bg-white border-r z-10">
                <ul className="flex-1 mt-4 px-2">
                    <SidebarButton onClick={onClose} text="Inicio" href="/inicio"/>
                    <SidebarButton onClick={onClose} text="Siguiendo" href="/siguiendo"/>
                    <SidebarButton onClick={onClose} text="Escribir" href="/escribir"/>
                    <SidebarButton text="Wiki" href="/wiki"/>
                    <EntityPopup/>
                    <SidebarButton onClick={onClose} text="Suscripciones" href="/suscripciones"/>
                </ul>
            </div>
            <button
