    ...
    return <div>
        {data.map((d, i) => {
            return <div key={i}>
                ...
                {d.months.length > 0 && <div>
                    <div>
                        Próximo mes:
                    </div>
                    <div>
                        {formatIsoDate(
                            new Date(new Date(d.months[d.months.length-1].end).getTime()+30*3600*1000*24))}
                    </div>
                </div>}
            </div>
        })}
