...
const PaywallChecker: React.FC<{children: ReactNode, requireSubscription?: boolean, requireAccount?: boolean}> = ({children, requireSubscription=true, requireAccount=true}) => {
    const user = useUser()
