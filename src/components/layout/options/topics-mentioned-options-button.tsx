...
import {TopicMentionsList} from "@/components/writing/article/publish-article-modal";


function useTopicsMentionedByContent(uri: string) {
    const {did, collection, rkey} = splitUri(uri)
    return useAPI<TopicMention[]>(`/topics-mentioned/${did}/${collection}/${rkey}`, ["topics-mentioned", uri])
}
