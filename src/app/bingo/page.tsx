...
const Page = () => {
    ...
    return (
        <div className="flex justify-between w-screen">
            ...
            <div className="w-64 flex items-end h-screen px-2">
            ...
            <div className="p-4 flex justify-center items-center flex-col">
                <div className="flex justify-center items-center px-2">
                    <h2 
                        className="text-gray-800 hover:text-blue-600 cursor-pointer text-4xl font-bold"
                ...
                <div className="grid grid-cols-10 gap-2 w-[600px] h-[600px] mt-4">
                    {toggledButtons.map((isToggled, index) => (
                        <button
                            key={index}
                            onClick={() => toggleButton(index)}
                            className={`w-12 h-12 border border-gray-500 text-lg rounded font-bold ${isToggled ? 'bg-green-400' : 'bg-white'}`}
                        >
                            {index + 1}
                        </button>
                    ))}
            ...
            <div className="w-64 flex flex-col items-center justify-end h-screen px-4">
