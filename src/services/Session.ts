import { AtpServiceClient } from '../app/xrpc-api'
import type { OutputSchema as RefreshSessionOutputSchema } from '../app/xrpc-api/types/com/atproto/server/refreshSession'
...
export const GenerateSessionManager = (): SessionManager => {
  ...
  const init = async (): Promise<void> => {
    console.log("generating session manager")
  ...
  const createSession = async (did: string, password: string, client: AtpServiceClient): Promise<UserData> => {
    ...
    console.log("create session returned", ret)
  ...
  console.log("generated session manager")
