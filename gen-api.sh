./node_modules/.bin/lex gen-api --yes ./src/lex-api \
  ...
  ../ca-server/lexicons/com/atproto/admin/* \
  ../ca-server/lexicons/com/atproto/repo/* \
  ../ca-server/lexicons/com/atproto/identity/* \
  ../ca-server/lexicons/com/atproto/label/* \
  ../ca-server/lexicons/com/atproto/server/* \
  ../ca-server/lexicons/com/atproto/moderation/* \
  ../ca-server/lexicons/com/atproto/lexicon/* \
  ../ca-server/lexicons/com/atproto/sync/* \
  ../ca-server/lexicons/com/atproto/temp/* \
  ...
  ../ca-server/lexicons/app/bsky/notification/* \
