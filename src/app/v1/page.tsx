...
const Page = () => {
    return <div className={"flex flex-col w-screen items-center justify-center h-screen"}>
        ...
        <div className={"mt-8 text-lg max-w-[600px] space-y-3 text-[var(--text-light)]"}>
            ...
            <p>
                En la nueva versión vas a poder recuperar todas tus publicaciones. Si necesitás acceder a algo antes escribinos a soporte@cabildoabierto.com.ar.
            </p>
